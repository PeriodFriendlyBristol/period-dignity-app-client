  ...
  return (
    <>
      ...
      <p>
        ...
        available to all who need them, while also combating outdated attitudes
        to periods.
      </p>
      <p>
        The Period Friendly Places vision is for Bristol to be a city of period
        dignity, in which nobody is held back in life or stigmatised against
        simply for having a period – this is part of our journey to being a
        period friendly city.
      </p>
      <p>
      ...
      <p>
        We are just at the beginning of this journey. To share feedback, please
        get in touch at{" "}
      ...
      {/*
          ...
          */}
      <p>
        The period dignity web app has been made by local web service designers
        and developers. Supported by Marius Jennings @ Bristol City Council's
        Innovation team,{" "}
